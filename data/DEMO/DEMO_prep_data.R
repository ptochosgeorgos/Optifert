...
df_demo_raw <- readxl::read_xlsx(here("raw_data/demo89_20_plant_220411.xlsx"), sheet = "Ertrag_89_19")
...
df_eea_raw <- read_csv2(here("raw_data/eea_report_LTE_2025_basic_analysis.CSV"))
...
# ACHTUNG: Dateipfad anpassen
spaltennamen <- names(read_xlsx(here("raw_data/DEMO_Nmin.xlsx"), sheet = "List", n_max = 0))
df_nmin_raw <- read_xlsx(here("raw_data/DEMO_Nmin.xlsx"), sheet = "List", skip = 4, col_names = spaltennamen)
...
write_csv(df_final, here("prep_data/DEMO_2025_cleansed.csv"))
